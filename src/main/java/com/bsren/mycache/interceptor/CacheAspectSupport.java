...
import static com.bsren.mycache.interceptor.SimpleKeyGenerator.generateKey;
...
public class CacheAspectSupport extends AbstractCacheInvoker
    ...
    private Object handleSynchronizedGet(CacheOperationInvoker invoker, Object key,Cache cache) {
        CacheAspectSupport.InvocationAwareResult invocationResult = new CacheAspectSupport.InvocationAwareResult();
