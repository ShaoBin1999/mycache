...
import com.bsren.mycache.interceptor.CacheEvictOperation;
import com.bsren.mycache.interceptor.CacheOperation;
import com.bsren.mycache.interceptor.CachePutOperation;
import com.bsren.mycache.interceptor.CacheableOperation;
...
public class CacheAdviceParser extends AbstractSingleBeanDefinitionParser {
    ...
    private RootBeanDefinition parseDefinitionSource(Element definition, ParserContext parserContext) {
        CacheAdviceParser.Props prop = new CacheAdviceParser.Props(definition);
        // add cacheable first
